# ============================================================
# CÓDIGO FINAL FEM: Puntos 11, 12 y 13 (Versión 5 - Fix de variable 'tol')
# ============================================================
...
# ----------------------------------------------------------------
#  2. GENERADOR DE MALLA GMSH (CORREGIDO: Definición de 'tol')
# ----------------------------------------------------------------
def generar_malla_anillo(NN_target, filename):
    
    # *** CORRECCIÓN: Definir 'tol' dentro de la función donde se usa ***
    tol = 1e-6 
